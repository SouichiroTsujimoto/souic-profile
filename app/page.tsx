          ...
          <div className={styles.cardInner}>
            ...
            <div className={styles.cardTitleRow}>
              ...
              <div className={styles.cardHp}>
                <span className={styles.cardTypeOrb} aria-hidden="true" />
              </div>
            </div>
            ...
            <div className={styles.cardMoves}>
              <TransitionLink href="/portfolio" className={styles.moveRow}>
            ...
            <div className={styles.cardFooter}>
              ...
              >
                ...
                <span className={styles.qrCaption}>wuhu1s.land</span>
              </div>
            </div>
          </div>
        </div>
